...
struct notification_type
{
  ...
  static std::string notification_to_string(e_notification_type e)
  {
    const std::map<e_notification_type, std::string> MyEnumStrings{
      { CONNECTION_REQUEST, "CONNECTION_REQUEST" }, { NEW_TRANSFER, "NEW_TRANSFER" },
      { UPDATE_REQUEST, "UPDATE_REQUEST" },         { GROUP_METADATA, "GROUP_METADATA" },
      { TRANSFER_ERROR, "TRANSFER_ERROR" },         { START_TRANSFER, "START_TRANSFER" },
      { TRANSFER_METADATA, "TRANSFER_METADATA" },   { PAUSE_TRANSFER, "PAUSE_TRANSFER" },
      { RESUME_TRANSFER, "RESUME_TRANSFER" },       { CANCEL_TRANSFER, "CANCEL_TRANSFER" }
    };
