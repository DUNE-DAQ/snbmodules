...
struct status_type
{
  ...
  enum e_status
  {
    ...
    PREPARING, // when the file is not yet available to execute transfer and need more time (ex: torrent file is being
               // generated)
    ERROR,
  ...
  {
    const std::map<e_status, std::string> MyEnumStrings{ { PREPARING, "PREPARING" },
                                                         { ERROR, "ERROR" },
  ...
  {
    const std::map<std::string, e_status> MyStringsEnum{ { "PREPARING", PREPARING },
                                                         { "ERROR", ERROR },
                                                         { "SUCCESS_UPLOAD", SUCCESS_UPLOAD },
                                                         { "SUCCESS_DOWNLOAD", SUCCESS_DOWNLOAD },
                                                         { "FINISHED", FINISHED },
