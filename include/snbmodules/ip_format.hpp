...
public:
  ...
  /// @brief  == operator
  bool operator==(IPFormat const& o) const { return m_ip == o.m_ip && m_port == o.m_port; }

  /// @brief  < operator
  bool operator<(IPFormat const& o) const { return m_ip.compare(o.m_ip) || (m_ip == o.m_ip && m_port < o.m_port); }
...
#ifndef _MSC_VER
  inline char* strtok_s(char* s, const char* delim, char** context) { return strtok_r(s, delim, context); }
#endif // !_MSC_VER

  /// @brief  Set the IP address, must be called after set_port() if the port is specified in the IP address ex
  /// 0.0.0.0:1234
