/**
 * @file transfer_metadata.hpp TransferMetadata class, used to store metadata of a transfer (one uploader to one
 * downloader)
 *
...
public:
  ...
  {
    return m_bytes_size == 0 ? 0 : static_cast<int>(m_bytes_transferred * 100 / m_bytes_size);
  }
