...
main()
{
  try {
    ...
    TransferMetadata transfer_metadata("./test.txt",
                                       100,
                                       IPFormat("192.168.0.107", 42100),
                                       "QOSFCBZAPOQDBSOsdonfsnodfnossnof4516",
                                       IPFormat("192.168.0.106", 999),
                                       "group1",
                                       50,
                                       status_type::e_status::WAITING);
