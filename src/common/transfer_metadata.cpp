/**
 * @file transfer_metadata.cpp TransferMetadata class, used to store metadata of a transfer (one uploader to one
 * downloader)
 *
...
std::string
TransferMetadata::export_to_string_partial(bool force_all)
{
  nlohmann::json j;
...
void
TransferMetadata::from_string(const std::string& str)
{
...
void
TransferMetadata::generate_metadata_file(std::filesystem::path dest)
{
...
void
TransferMetadata::load_metadata_from_meta_file(std::filesystem::path src)
{
